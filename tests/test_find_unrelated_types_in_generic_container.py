...
params = [
    ...
    (True, FindUnrelatedTypesInGenericContainer(), 'DMI_USING_REMOVEALL_TO_CLEAR_COLLECTION', 'OBlock.java',
    ...
    (True, FindUnrelatedTypesInGenericContainer(), 'DMI_VACUOUS_SELF_COLLECTION_CALL', 'TestConcatenatedLists.java',
     ...
     1, 969),
    # DIY
    (True, FindUnrelatedTypesInGenericContainer(), 'DMI_VACUOUS_SELF_COLLECTION_CALL', 'OBlock.java',
     '''@@ -963,6 +967,7 @@   private void verify(ConcatenatedLists<Long> c, int last) {
            assertEquals((last == -1), c.isEmpty());
            assertEquals(last + 1, c.size());
    ...
    (True, FindUnrelatedTypesInGenericContainer(), 'DMI_COLLECTIONS_SHOULD_NOT_CONTAIN_THEMSELVES', 'OBlock.java',
     '''@@ -963,6 +967,7 @@
     ...
     1, 969),
    # DIY
    (True, FindUnrelatedTypesInGenericContainer(), 'DMI_COLLECTIONS_SHOULD_NOT_CONTAIN_THEMSELVES',
